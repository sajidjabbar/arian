...
<!--  Start Here -->
    ...
    <section id="hero" class="d-flex align-items-center">
        <div class="container">
            ...
            <h1>we rise by <br>
                lifting others</h1>
            <h2 class="w-50">Call us for a free consultation to discuss how we can provide the service you need, with the quality you deserve.</h2>
            <div class="d-flex">
    ...
    <main id="main">
        <section id="featured-services" class="featured-services">
            <img src="img/main-img.png" class="img-fluid">
        </section>
